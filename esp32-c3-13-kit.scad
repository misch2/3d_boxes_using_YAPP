...
// V1: initial version, too high, too long, pins too far away (PCB doesn't fit), USB port too small
// V2: larger USB port, lower and shorter box, pins position fixed
...
paddingFront        = 5;    // more space to bend sensor cables
paddingBack         = 3;
paddingRight        = 3;
paddingLeft         = 3;
...
// (3) = { yappHole, YappPin }
pcbStands = [
  [ 2.2,        2.3,        yappBoth, yappPin],
  [ 2.2,        2.3 + 20.9, yappBoth, yappPin],
  [ 2.2 + 43.6, 2.3,        yappBoth, yappPin],
  [ 2.2 + 43.6, 2.3 + 20.9, yappBoth, yappPin] 
];     
...
cutoutsGrill = [
  [ 8, 2, 22, 32, 2, 2, 45, "base" ],
  [ 8, 2, 22, 32, 2, 2, 45, "lid" ],
];
