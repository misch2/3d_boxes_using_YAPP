...
standoffHeight      = 3.0;        // 3mm reserve is perfectly OK
pinDiameter         = 2.5 - 0.1;  // 2.5mm hole in the PCB - .1mm slack
...
// (3) = { yappHole, YappPin }
pcbStands = [
  [2.4 + 29.1, 2.4 + 44.5, yappBoth, yappPin],
  [2.4 + 29.1, 2.4,        yappBoth, yappPin],
  [2.4,        2.4,        yappBoth, yappPin]
];     
...
// (6) = { yappCenter }
cutoutsBack =   [
  [ 21, -2,  24, 5, 0, yappRectangle] // data cables to sensor
];
